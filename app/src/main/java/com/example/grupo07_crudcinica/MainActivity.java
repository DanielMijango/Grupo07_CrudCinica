...
public class MainActivity extends AppCompatActivity {
    Button btnClinica, btnEspecialidad, btnDoctor, btnPaciente, btnConsulta, btnFactura, btnMedicamento, btnSeguro, btnHospital, btnDetalleFactura, btnHospitalizacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHospitalizacion.setOnClickListener(v -> startActivity(new Intent(this, ActivityHospitalizacionMenuBinding.class)));
